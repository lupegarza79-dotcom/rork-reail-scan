      ...
      >
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Pressable
              onPress={() =>
                update({ language: settings.language === "en" ? "es" : "en" })
              }
              style={({ pressed }) => [
                styles.pillBtn,
        ...
        <View style={styles.section}>
          ...
          <View style={styles.privacyNote}>
            ...
            <Text style={styles.privacyText}>
              REAiL analyzes public signals only. We do not access your private
              data, contacts, or files.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.deviceActions}>
            <Pressable
              ...
              style={({ pressed }) => [
                styles.deviceBtn,
                pressed && styles.deviceBtnPressed,
              ]}
            >
            ...
            <Pressable
              ...
              style={({ pressed }) => [
                styles.deviceBtn,
                styles.deviceBtnDanger,
                pressed && styles.deviceBtnDangerPressed,
              ]}
            >
              <Trash2 size={14} color={Colors.highRisk} strokeWidth={2} />
              <Text style={[styles.deviceBtnText, { color: Colors.highRisk }]}>
                Clear All Data
              </Text>
            </Pressable>
          </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.disclaimerCard}>
            ...
            <Text style={styles.disclaimerText}>
              REAiL provides risk-based verification using public signals and
              automated analysis. It does not claim absolute truth. Results are
              risk-based, not definitive.
            </Text>
          </View>
